    ...
    messageDesc.field.forEach((field) => {
        ...
        if ((0, types_1.isRepeated)(field)) {
            if ((0, types_1.isMapType)(ctx, messageDesc, field)) {
                const mapInfo = (0, types_1.detectMapType)(ctx, messageDesc, field);
          ...
          `);
            ...
            else if ((0, types_1.packedField)(field, currentFile.isProto3Syntax) === undefined) {
...
function generateExtension(ctx, message, extension) {
    ...
    const packed = (0, types_1.isRepeated)(extension) && (0, types_1.packedField)(extension, currentFile.isProto3Syntax);
    ...
    messageDesc.field.forEach((field) => {
        ...
        const readSnippet = (from) => {
            if ((0, types_1.isEnum)(field)) {
                ...
                (options.useDate === options_1.DateOption.DATE ||
                    options.useDate === options_1.DateOption.TEMPORAL ||
                    options.useDate === options_1.DateOption.TIMESTAMP)) {
        ...
        if (canonicalFromJson[fullTypeName]?.[fieldName]) {
            ...
            if ((0, types_1.isMapType)(ctx, messageDesc, field)) {
                ...
                if ((0, types_1.shouldGenerateJSMapType)(ctx, messageDesc, field)) {
                    ...
                    if (options.protoJsonFormat && field.name !== field.jsonName) {
                        const protoJsonProperty = (0, utils_1.getPropertyAccessor)("object", field.name);
          ...
          `);
                ...
                if (!needMap) {
                    if (options.protoJsonFormat && field.name !== field.jsonName) {
                        const protoJsonProperty = (0, utils_1.getPropertyAccessor)("object", field.name);
                        const protoJsonPropertyOptional = (0, utils_1.getPropertyAccessor)("object", field.name, true);
  ...
  `);
    ...
    messageDesc.field.forEach((field) => {
        ...
        const readSnippet = (from) => {
            if ((0, types_1.isEnum)(field)) {
            ...
            else if ((0, types_1.isTimestamp)(field) && options.useDate === options_1.DateOption.TEMPORAL) {
                return (0, ts_poet_1.code) `${from}.toString()`;
            }
            else if ((0, types_1.isTimestamp)(field) &&
                (options.useDate === options_1.DateOption.STRING || options.useDate === options_1.DateOption.STRING_NANO)) {
                ...
                else if ((0, types_1.isTimestamp)(valueType) && options.useDate === options_1.DateOption.TEMPORAL) {
                    return (0, ts_poet_1.code) `${from}.toString()`;
                }
